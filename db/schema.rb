...
ActiveRecord::Schema.define(version: 2022_07_08_175526) do
  ...
  create_table "users", id: :serial, force: :cascade do |t|
    ...
    t.string "apellidos"
    t.string "nombres"
    t.string "cif_file_name"
    t.string "cif_content_type"
    t.bigint "cif_file_size"
    t.datetime "cif_updated_at"
    t.string "cid_file_name"
    t.string "cid_content_type"
    t.bigint "cid_file_size"
    t.datetime "cid_updated_at"
    t.string "constancia_file_name"
    t.string "constancia_content_type"
